...
urlpatterns = [
    ...
    path('register_panitia_page/', register_panitia_page, name='register_panitia_page'),
    path('register_manager_page/', register_manager_page, name='register_manager_page'),
    path('register_penonton_page/', register_penonton_page, name='register_penonton_page'),
